...
let percentual_brancos = ((votos_brancos * 100.0) / total_eleitores).toFixed(2);
let percentual_nulos = ((votos_nulos * 100.0) / total_eleitores).toFixed(2);
let percentual_validos = ((votos_validos * 100.0) / total_eleitores).toFixed(2);
